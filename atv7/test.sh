#!/usr/bin/env bash
# Testes do compilador EC2 com verificacao automatica.
#
...
v12_soma_mult v13_combinada v14_precedencia v15_assoc_sub \
v16_assoc_div v17_paren_precedencia v18_sem_paren_grande \
v19_peek_fecha_paren"
...
e5_div_zero_aninhada e6_exp_incompleta e7_operador_duplo \
e8_fecha_paren e9_tokens_extras e10_div_zero_sem_paren e11_unario"

for nome in $invalidos; do
  echo "Teste invalido: $nome.ec1"
  if python3 compec2.py "testes/$nome.ec1" -o "$tmp/$nome.s" >/dev/null 2>&1; then
